...
<body>
  ...
  <section class="hero" aria-labelledby="hero-title">
    <div class="hero-icons" role="img" aria-label="Illustration of smartphone map with clock icons and server with stopwatch icon">
      <img src="{{ asset('images/Group 34.png') }}" alt="Isometric smartphone with map showing locations and clock, representing real-time tracking" onerror="this.style.display='none'" />
    </div>
    <h1 class="hero-title" id="hero-title">Laporan Otomatis dan Terintegrasi</h1>
    <p class="hero-text">
      Hasilkan laporan lengkap terkait penggunaan alat, aktivitas tim, dan logistik secara otomatis tanpa proses manual yang rumit. Semua data tercatat secara real-time dan terintegrasi dalam satu sistem, sehingga mempercepat analisis dan mendukung pengambilan keputusan yang lebih tepat, akurat, dan berbasis data aktual di lapangan.
    </p>
