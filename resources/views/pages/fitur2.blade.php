...
<body>
  ...
  <section class="hero" aria-labelledby="hero-title">
    <div class="hero-icons" role="img" aria-label="Illustration of smartphone map with clock icons and server with stopwatch icon">
      <img src="{{ asset('images/Group 33.png') }}" alt="Isometric smartphone with map showing locations and clock, representing real-time tracking" onerror="this.style.display='none'" />
    </div>
    <h1 class="hero-title" id="hero-title">Manajemen Inventaris Alat</h1>
    <p class="hero-text">
      Catat dan kelola seluruh data alat secara menyeluruh, mulai dari jumlah, kondisi fisik, lokasi penyimpanan, hingga riwayat penggunaan dalam satu sistem terpusat. Fitur ini memudahkan proses pemantauan, mempercepat pencarian alat, serta membantu dalam perencanaan kebutuhan dan perawatan alat secara lebih efisien dan terorganisir.
    </p>
