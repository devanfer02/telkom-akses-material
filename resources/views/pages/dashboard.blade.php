...
@section('content')
    ...
    <body>
        ...
        <section class="main-image-container"
            aria-label="Telkom Akses office building with overlayed illustration of two technicians in red uniform and safety helmet walking together">
            <img src="{{ asset('images/Frame-11.png') }}"
                alt="Modern Telkom Akses office building facade with grey cladding and large windows under a clear sky" />
        ...
        <section class="stats-bar" aria-label="Website statistics summary cards">
            <div class="stat-card" tabindex="0" role="group" aria-labelledby="lbl-views val-views">
                <div class="stat-label" id="lbl-views">Jumalah User</div>
                <div class="stat-value" id="val-views">{{ $data['totalUser'] }}</div>
            ...
            <div class="stat-card" tabindex="0" role="group" aria-labelledby="lbl-visits val-visits">
                <div class="stat-label" id="lbl-visits">Jumlah Material</div>
                <div class="stat-value" id="val-visits">{{ $data['totalMaterial'] }}</div>
            ...
            <div class="stat-card" tabindex="0" role="group" aria-labelledby="lbl-new-users val-new-users">
                <div class="stat-label" id="lbl-new-users">Jumlah Material IN</div>
                <div class="stat-value" id="val-visits">{{ $data['inMaterial'] }}</div>
            ...
            <div class="stat-card" tabindex="0" role="group" aria-labelledby="lbl-active-users val-active-users">
                <div class="stat-label" id="lbl-new-users">Jumlah Material OUT</div>
                <div class="stat-value" id="val-visits">{{ $data['outMaterial'] }}</div>
        ...
        <!-- Kalender table -->
        <div
            style="max-width: 800px; margin: auto; padding: 30px; background: #0a0a0a; border-radius: 20px; box-shadow: 0 10px 30px rgba(0,0,0,0.4); color: white; font-family: 'Segoe UI', sans-serif;">
